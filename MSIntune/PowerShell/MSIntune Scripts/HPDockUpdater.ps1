...
$ScriptVersion = 'DockUpdater.ps1: 01.00.16 Feb 27, 2024'
...
function Get-HPDockInfo {
    ...
    $Url_TBG2 = 'ftp.hp.com/pub/softpaq/sp143501-144000/sp143977.exe'   #  (as of Jan 3, 2024)
    $Url_TBG4 = 'ftp.hp.com/pub/softpaq/sp149501-150000/sp150000.exe'   #  (as of Jan 3, 2024)
    $Url_UniG2 = 'ftp.hp.com/pub/softpaq/sp146001-146500/sp146291.exe'  #  (as of Jan 3, 2024)
    $Url_UsbG5 = 'ftp.hp.com/pub/softpaq/sp146001-146500/sp146273.exe'  #  (as of Jan 3, 2024)
    $Url_UsbG4 = 'ftp.hp.com/pub/softpaq/sp88501-89000/sp88999.exe'     #  (as of Jan 3, 2024)
    $Url_EssG5 = 'ftp.hp.com/pub/softpaq/sp149501-150000/sp149576.exe'  #  (as of Jan 3, 2024)
    $Url_E24dG4 = 'ftp.hp.com/pub/softpaq/sp145501-146000/sp145577.exe'  #  (as of Jan 3, 2024)
    $Url_E27dG4 = 'ftp.hp.com/pub/softpaq/sp145501-146000/sp145576.exe'  #  (as of Jan 3, 2024)
    $Url_Z40cG3 = 'ftp.hp.com/pub/softpaq/sp147501-148000/sp147688.exe'  #  (as of Jan 3, 2024)
    $Url_EOPOCI = 'ftp.hp.com/pub/softpaq/sp144501-145000/sp144902.exe' # (as of Jan 3, 2024)
...
if ( $Dock.Dock_Attached -eq 0 ) {
    ...
    if ( $BypassHPCMSL ) {
        ...
        Try {
            ...
            Write-Host "-- Failed to obtain reference file for this platform and OS version - "$Err -ForegroundColor Cyan
            return -1
        }        
    ...
    if (Test-Path "$OutFilePath\$SPNumber\HPFirmwareInstaller.exe") { # Run version check - Check if Update Required
        ...
        if ( $Dock.Dock_Attached -eq 9 ) {  # Essential dock found - must handle uniquely
...
#>
#return $Dock.Dock_Attached         # return dock connected (internal script dock number)
return $HPFirmwareTest.ExitCode     # return of error code as requested by Spanish 
